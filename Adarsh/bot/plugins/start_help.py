...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/Logesh_bots'>CLICK HERE FOR SUPPORT </a></b>",
                
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/c93eb3bf40a4750fa23a6.jpg",
        caption =f'Hi {m.from_user.mention(style="md")}!,\nI am Telegram File to Link Generator Bot with Channel support.\nSend me any file and get a direct download link and streamable link.!\n\nThis bot is powered by @LOGESHBOTS',
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [LOGESH](https://t.me/Logesh_bots).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/Logesh_bots")],
                [InlineKeyboardButton("💥 Source Code", url="https://t.me/Logesh_bots")]
            ]
        )
    )
